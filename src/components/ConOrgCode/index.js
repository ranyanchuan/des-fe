...
class ConOrgCode extends React.Component {

  checkOrgCode = (rule, value, callback) => {
    if (this.orgCode(value)) {
      callback(true);
    } else {
      callback(false);
    }
  ...
  orgCode = (str) => {  //统一社会信用代码
    ...
    */
    ...
    /*
         ...
         255÷11=33，余数是2。​​
      */
    let firstkey = this.onCalc(code.substr(8), firstarray, firstkeys, 11);
    /*
    ...
    */
    ...
    let secondkey = this.onCalc(code, secondarray, secondkeys, 31);
    /*
            ...
            rules: [{
            ...
            },
              {
                validator: (rule, value, callback) => {
                  ...
                  if (value && !this.orgCode(value)) {
                    callback('请正确输入组织机构代码');
                  }
                  callback();
                },
              },
